        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @foreach ($this->pastEnrollments as $enrollment)
                <div class="relative group h-full">
                    <a href="{{ route('student.performance-analytics', $enrollment->id) }}" wire:navigate class="absolute inset-0 z-20"></a>
                    
                    <div class="p-6 md:p-8 rounded-3xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 shadow-sm relative overflow-hidden transition-all group-hover:shadow-lg group-hover:border-emerald-500/50 group-hover:-translate-y-1 duration-300 h-full flex flex-col">
