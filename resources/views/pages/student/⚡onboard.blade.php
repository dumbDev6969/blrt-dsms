                ...
                <flux:fieldset>
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Your educational and professional background</p>
                        </div>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {{-- Educational Attainment (New Enum Field) --}}
                        <flux:select wire:model="educational_attainment" label="Highest Educational Attainment" placeholder="Select Level...">
                        ...
                        <flux:input wire:model.blur="occupation" label="Current Occupation" icon="briefcase" placeholder="e.g. Software Engineer" />
                    </div>
                </flux:fieldset>
                ...
                <flux:fieldset>
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">How can we reach you and verify your records?</p>
                        </div>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {{-- Contact Details --}}
                        <flux:input wire:model.blur="contact_number" label="Phone Number" icon="phone" placeholder="+63" />
                        
                        {{-- LTMS Client ID --}}
                        <flux:input wire:model.blur="ltms_client_id" label="LTMS Client ID" icon="finger-print" />

                        {{-- Student Permit/License (New Field) --}}
                        <flux:input wire:model.blur="student_permit_or_license_no" label="Student Permit / License No." icon="identification" class="sm:col-span-2" placeholder="Enter license number if applicable" />
                        
                        {{-- Address --}}
                        <flux:textarea wire:model.blur="address" label="House no., Purok, Brgy, City, Province" class="sm:col-span-2" rows="3" placeholder="Complete permanent address" />
                    </div>
                </flux:fieldset>
